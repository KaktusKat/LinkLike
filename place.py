...
class place:
   ...
   def create(self, screen, player, enemy_list,tool1,tool2,keys,invet):
      ...
      for x in range(-5, 5):
         for y in range(-5, 5):
            ...
            if key in self.map_dic:
               ...
               self.map_dic[key] = random.randint(0, 3)
               ...
               if self.map_dic[key] == ROCK:
                  if random.randint(0,4) == 0:
                     t = tile(["rock.png"],xPos,yPos,58,58, soild = True,breakable = False)
                     if xPos == 0 and yPos == 0: 
                        t = tile(["grass.png"],xPos,yPos,58,58, soild = True)
                     self.map_dic[key] = t
                  else:
